import {
  ImageCanvas_default
} from "./chunk-HLZSNNWT.js";
import "./chunk-F3ARDFTC.js";
import "./chunk-3J3ZUBBH.js";
import "./chunk-66C2U62X.js";
...
// node_modules/ol-ext/util/Worker.js
...
var Worker_default = ol_ext_Worker;

// node_modules/ol-ext/source/IDW.js
var ol_source_IDW = class olsourceIDW extends ImageCanvas_default {
  constructor(options) {
    options = options || {};
    ...
    if (options.useWorker) {
      ...
      this.worker = new Worker_default(this.computeImage, {
    ...
    this._weight = typeof options.weight === "function" ? options.weight : function(f) {
  ...
  computeImage(e) {
    ...
    return { type: "image", data: imageData, width, height };
  }
  ...
  calculateImage(extent, resolution, pixelRatio, size) {
    ...
    if (this.worker) {
      this.worker.postMessage({ pts, width, height }, true);
      this.dispatchEvent({ type: "drawstart" });
      if (this._canvas.width !== Math.round(size[0]) || this._canvas.height !== Math.round(size[1]) || this._position.resolution !== resolution || this._position.extent[0] !== extent[0] || this._position.extent[1] !== extent[1]) {
      ...
      this._canvas.width = Math.round(size[0]);
      this._canvas.height = Math.round(size[1]);
      var imageData = this.computeImage({ data: { pts, width, height } });
...
var IDW_default = ol_source_IDW;
export {
  IDW_default as default
};
//# sourceMappingURL=ol-ext_source_IDW.js.map
